...
DOR_Parcel.sf <-
  DOR_Parcel.sf %>%
  mutate(light.nn5 = ifelse(nrow(light.sf)>=5, nn_function(st_coordinates(DOR_Parcel.sf),st_coordinates(light.sf), 5),"Null"),
         heat.nn5 =ifelse(nrow(heat.sf)>=5, nn_function(st_coordinates(DOR_Parcel.sf),st_coordinates(heat.sf), 5),"Null"),
         infestation.nn5 =ifelse(nrow(infestation.sf)>=5, nn_function(st_coordinates(DOR_Parcel.sf),st_coordinates(infestation.sf), 5),"Null"),
         Detector.nn5 =ifelse(nrow(Detector.sf)>=5,
nn_function(st_coordinates(DOR_Parcel.sf),st_coordinates(Detector.sf), 5),"Null"),
         Dangerous.nn5 =ifelse(nrow(Dangerous.sf)>=5, 
